...
# 3. Hardened Directories and Permissions
...
LABEL org.opencontainers.image.title="Hardened PostGIS, TimescaleDB & pg_cron" \
      org.opencontainers.image.description="PostgreSQL 18 based on Rocky Linux 9.7. Features: Locked postgres user, SCRAM-SHA-256 auth, automatic password sync, and native pg_cron scheduling." \
